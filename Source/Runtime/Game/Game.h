...
#define GAME_SERVER_PORT 42000
#define GAME_LANINFO_PORT 41998
#define GAME_MASTER_PORT 41999
#define PROTOCOL_VERSION 2              // bump when protocol changes
#define DEMO_VERSION 1                  // bump when demo format changes
#define DEMO_MAGIC "GAME_DEMO\0\0"
...
static const struct guninfo { const char *name, *file, *vwep; int attacks[NUMACTS]; } guns[NUMGUNS] =
{
	...
	{ "shotgun", "shotgun", "Weapons/World/Shotgun",{ -1, ATK_PULSE_SHOOT, ATK_PULSE_MELEE } }
};
