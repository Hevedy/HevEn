...
// ---------------------------------------------------------------------------
//  File:			Main.cpp
//  Description: 	Engine initialisation & main loop
// ---------------------------------------------------------------------------
//  Log:			Source.
//
//
...
void setupscreen()
{
    ...
    screen = SDL_CreateWindow("HevEn", winx, winy, winw, winh, SDL_WINDOW_OPENGL | SDL_WINDOW_SHOWN | SDL_WINDOW_INPUT_FOCUS | SDL_WINDOW_MOUSE_FOCUS | flags);
...
void stackdumper(unsigned int type, EXCEPTION_POINTERS *ep)
{
    ...
    char out[512];
    formatstring(out, "HevEn Win32 Exception: 0x%x [0x%x]\n\n", er->ExceptionCode, er->ExceptionCode==EXCEPTION_ACCESS_VIOLATION ? er->ExceptionInformation[1] : -1);
