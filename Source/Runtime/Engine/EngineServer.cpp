...
// 
// ---------------------------------------------------------------------------
//  File:			EngineServer.cpp
//  Description: 	Little more than enhanced multicaster, runs dedicated or as client coroutine
// ---------------------------------------------------------------------------
//  Log:			Source.
//
//
...
#ifdef WIN32
    MessageBox(NULL, msg, "HevEn fatal error", MB_OK|MB_SYSTEMMODAL);
#else
...
void initserver(bool listen, bool dedicated)
{
    ...
    {
#ifdef WIN32
        setupwindow("HevEn Server");
#endif
    }

    execfile("Config/ServerInit.cfg", false);
